...
// output
  ...
  private static boolean compareOutput(TestCase testCase, int caseNumber, String output,
      PrintStream originalOut) {
    System.setOut(originalOut);
    String strippedOutput = removeTrailingSpaces(output);
  ...
  private static void handleException(PrintStream originalOut, int caseNumber, TestCase testCase,
